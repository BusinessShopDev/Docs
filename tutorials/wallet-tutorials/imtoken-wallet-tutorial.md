...
Below tutorial will help you understand how to add BusinessShop network RPC on imToken through chainlist.org and transfer/receive tokens on fuse network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “BusinessShop” on the list of EVM networks. Click on “Add to imToken” next to BusinessShop Mainnet and “Approve” the details of BusinessShop RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added BusinessShop network RPC on imToken wallet. You can now send/receive BusinessShop network assets on imToken wallet.  
