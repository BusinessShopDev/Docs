...
The BusinessShop Studio REST API for accessing the data and the services of the BusinessShop network in a simple way. You can use this API to query and interact with the objects of the BusinessShop network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and BusinessShop network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(BusinessShop\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the BusinessShop network |
...
| homeBridgeAddress | `String` | Bridge address on the BusinessShop network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the BusinessShop network |
...
Community is a set of contracts and services. Members of the community are users of the BusinessShop network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the BusinessShop network |
| homeTokenAddress | `String` | Address of the community token on the BusinessShop network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the BusinessShop network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the BusinessShop network |
...
Entity is an account on the BusinessShop network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on BusinessShop network |
...
Tokens are compatible with the BSP20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
