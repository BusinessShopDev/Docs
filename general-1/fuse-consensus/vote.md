...
BusinessShop chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://bspexplorer.com/address/0x14727bf652D7579b6D40A3bcc72BeaC14411D112) with the following params:
...
Some other useful functions on the [voting contract](https://bspexplorer.com/address/0x14727bf652D7579b6D40A3bcc72BeaC14411D112) are:
